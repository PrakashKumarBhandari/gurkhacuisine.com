...
<div>
    <form method="post" action="options.php">
        ...
        <table>
        <tr valign="top">
                <th scope="row" width="30%"><?php _e( 'Top Left Content' ); ?></th>
                <td  width="70%">                    
                    <textarea id="theme_settings[topleft]" name="theme_settings[topleft]" rows="5"
                        cols="36"><?php esc_attr_e( $options['topleft'] ); ?></textarea>
                    </td>
            </tr>
            <tr valign="top">
                <th scope="row" width="30%"><?php _e( 'Footer Contact us' ); ?></th>
                <td  width="70%">                    
